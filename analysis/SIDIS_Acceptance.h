...
class SIDIS_Acceptance{
    ...
    public:
        ...
        void Init(){/*{{{*/
            //CLEO
            TString ele_filename = "/work/halla/solid/yez/dvmp/acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_negative_output.root";
            TString pos_filename = "/work/halla/solid/yez/dvmp/acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_positive_output.root";
            TString neu_filename = "/work/halla/solid/yez/dvmp/acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_neutral_output.root";
            TString pip_filename = "/work/halla/solid/yez/dvmp/acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_positive_output.root";
            TString pim_filename = "/work/halla/solid/yez/dvmp/acceptance/CLEO_SIDIS_He3/acceptance_solid_CLEO_SIDIS_3he_negative_output.root";
            ...
            accep_neg_forward_theta = (TH1F*) accep_ele_forward->ProjectionX("accep_neg_forward_theta");
            accep_neg_large_theta = (TH1F*) accep_ele_large->ProjectionX("accep_neg_large_theta");
            ...
            accep_pos_forward_theta = (TH1F*) accep_pos_forward->ProjectionX("accep_pos_forward_theta");
            accep_pos_large_theta = (TH1F*) accep_pos_large->ProjectionX("accep_pos_large_theta");
            ...
            accep_neu_forward_theta = (TH1F*) accep_neu_forward->ProjectionX("accep_neu_forward_theta");
            accep_neu_large_theta = (TH1F*) accep_neu_large->ProjectionX("accep_neu_large_theta");
        ...
        double GetAcc(TString kPID, TString kRegion, double kP, double kTheta){/*{{{*/
            ...
            if(kRegion=="FA"||kRegion=="fa"||kRegion=="Forward"||kRegion=="forward"){
                ...
                else if(kPID=="e+"||kPID=="pos"||kPID=="positron"||kPID=="p"||kPID=="pro"||kPID=="proton")
        ...
        double GetThetaAcc(TString kPID, TString kRegion, double kTheta){/*{{{*/
            int theta_bin=int(kTheta/0.2)+1;    //0.2 degree per bin
			double acc=0.0;

            if(kRegion=="FA"||kRegion=="fa"||kRegion=="Forward"||kRegion=="forward"){
                if(kPID=="e-"||kPID=="ele"||kPID=="electron"||kPID=="negative")
                    acc=accep_neg_forward_theta->GetBinContent(theta_bin);
                else if(kPID=="e+"||kPID=="pos"||kPID=="positron"||kPID=="p"||kPID=="pro"||kPID=="proton"||kPID=="positive")
                    acc=accep_pos_forward_theta->GetBinContent(theta_bin);
                else if(kPID=="neutron"||kPID=="photon"||kPID=="neu"||kPID=="pho"||kPID=="n"||kPID=="g"||kPID=="neutral")
                    acc=accep_neu_forward_theta->GetBinContent(theta_bin);
                else{
                    cerr<<"*** ERROR, I don't know this particle = "<<kPID.Data()<<endl;
                    return 0.0;
                }
            ...
            if(kRegion=="LA"||kRegion=="la"||kRegion=="large"||kRegion=="Large"){
                if(kPID=="e-"||kPID=="ele"||kPID=="electron"||kPID=="negative")
                    acc=accep_neg_large_theta->GetBinContent(theta_bin);
                else if(kPID=="e+"||kPID=="pos"||kPID=="positron"||kPID=="p"||kPID=="pro"||kPID=="proton"||kPID=="positive")
                    acc=accep_pos_large_theta->GetBinContent(theta_bin);
                else if(kPID=="neutron"||kPID=="photon"||kPID=="neu"||kPID=="pho"||kPID=="n"||kPID=="g"||kPID=="neutral")
                    acc=accep_neu_large_theta->GetBinContent(theta_bin);
                else{
                    cerr<<"*** ERROR, I don't know this particle = "<<kPID.Data()<<endl;
                    return 0.0;
                }
    ...
    private:
        ...
        TH1F *accep_pos_forward_theta;
        TH1F *accep_pos_large_theta;  
        TH1F *accep_neg_forward_theta;
        TH1F *accep_neg_large_theta;          
        TH1F *accep_neu_forward_theta;
        TH1F *accep_neu_large_theta;  
  /*}}}*/
};
