{
  ...
  T->Draw("Q2:t>>h1","weight*time*(ele_acc_f+ele_acc_l)*pim_acc_f*(W>2.0&&Epsilon>0.55&&Epsilon<0.75&&(pro_mom<1.0&&(pro_theta>8.&&pro_theta<14.8)||(pro_theta>16&pro_theta<24)))","colz");
