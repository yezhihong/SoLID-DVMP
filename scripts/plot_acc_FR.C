...
/*}}}*/
    ...
    //k1->GetZaxis()->SetRangeUser(0.000, 0.01);
    //k2->GetZaxis()->SetRangeUser(0.000, 0.01);
    //k3->GetZaxis()->SetRangeUser(0.000, 0.01);

    c2->cd(1);
    T->Draw("ele_mom:ele_theta>>k1",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(Q2>4.0&&W>2)*(%s)", pro_cut0.Data()),"colz");
    gPad->SetLogz(1);
    c2->cd(2);
    T->Draw("pim_mom:pim_theta>>k2",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(Q2>4.0&&W>2)*(%s)", pro_cut0.Data()),"colz");
    gPad->SetLogz(1);
    c2->cd(3);
    T->Draw("pro_mom:pro_theta>>k3",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(Q2>4.0&&W>2)*(%s)", pro_cut0.Data()),"colz");
    gPad->SetLogz(1);
    c2->Modified();
    c2->Update();
...
/*}}}*/
    ...
    //j1->GetZaxis()->SetRangeUser(0.0001, 0.01);
    //j2->GetZaxis()->SetRangeUser(0.0001, 0.01);
    //j3->GetZaxis()->SetRangeUser(0.0001, 0.01);

    c3->cd(1);
    T->Draw("ele_mom:ele_theta>>j1",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(%s)*(Q2>4.0&&W>2)", pro_cut.Data()),"colz");
    gPad->SetLogz(1);
    c3->cd(2);
    T->Draw("pim_mom:pim_theta>>j2",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(%s)*(Q2>4.0&&W>2)", pro_cut.Data()),"colz");
    gPad->SetLogz(1);
    c3->cd(3);
    T->Draw("pro_mom:pro_theta>>j3",Form("weight*(ele_acc_f+ele_acc_l)*(pim_acc_f)*(%s)*(Q2>4.0&&W>2)", pro_cut.Data()),"colz");
    gPad->SetLogz(1);
    c3->Modified();
    c3->Update();
