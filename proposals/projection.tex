...
\begin{figure}[!ht]
 \begin{center}
         \subfloat[w/o PRD]{
               \includegraphics[type=pdf,
        ext=.pdf,read=.pdf,width=0.45\textwidth]{./figures/bin_asym_t_zoom} }
            \subfloat[w/ PRD]{
      \includegraphics[type=pdf,
        ext=.pdf,read=.pdf,width=0.45\textwidth]{./figures/bin_asym_t_prd_zoom} }
...
%	   $<A_{UT}>$        &$-1.13\times 10^{-1}$   & $-2.14\times 10^{-1}$   & $-2.72\times 10^{-1}$    & $-2.95\times 10^{-1}$    & $-3.07\times 10^{-1}$    & $-2.94\times 10^{-1}$   & $-2.47\times 10^{-1}$   \\
%           $\delta A_{UT}$  &  $6.75\times 10^{-3}$   & $3.70\times 10^{-3}$    &   $4.38\times 10^{-3}$  &  $5.85\times 10^{-3}$   &  $8.19\times 10^{-3}$   &   $9.05\times 10^{-3}$ &   $1.25\times 10^{-2}$ \\
...
%	   $<A_{UT}>$        &$-1.31\times 10^{-1}$   & $-3.02\times 10^{-1}$   & $-4.12\times 10^{-1}$    & $-4.60\times 10^{-1}$    & $-4.75\times 10^{-1}$    & $-4.40\times 10^{-1}$   & $-2.93\times 10^{-1}$   \\
%	   $\delta A_{UT}$  &  $6.49\times 10^{-3}$   & $3.11\times 10^{-3}$    &   $3.28\times 10^{-3}$  &  $3.93\times 10^{-3}$   &  $4.87\times 10^{-3}$   &   $4.51\times 10^{-3}$ &   $4.89\times 10^{-3}$ \\
